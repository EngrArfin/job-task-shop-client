                ...
                <ul className="menu p-4 w-80 min-h-full text-black bg-white">
                    ...
                    <div className="navbar bg-base-100">
                        <div className="dropdown" onMouseOver={handleMouseOver} onMouseOut={handleMouseOut}>
                            <button className="dropdown-btn"><MdHome />Home</button>
                            {showDropdown && (
                                <ul className="menu menu-sm dropdown-content mt-3 z-[2] p-2 shadow bg-base-100 rounded-box w-52" id="dropdownMenu">
                                    <li><Link ><MdHome />Home 1</Link></li>
                                    <li>
                                        <a className='mr-4 uppercase mt-4'><MdHome />Home</a>
                                        <ul className="p-2">
